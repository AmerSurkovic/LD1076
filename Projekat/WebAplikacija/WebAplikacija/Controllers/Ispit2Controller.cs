...
namespace WebAplikacija.Controllers
{
    public class Ispit2Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ispitID,brojPrijavljenih,termin")] Ispit ispit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ispitID,brojPrijavljenih,termin")] Ispit ispit)
        {
            if (ModelState.IsValid)
            {
